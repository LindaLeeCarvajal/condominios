...
// aqui deberia de haber un metodo que verifique si estos digitos ya existe o no en la base de datos
...
function cargarDataArticulo(idarticulo, idcategoria, idunidad_medida, nombre, descripcion,instruccion,numero,vrestringida,codigo_interno,minima, imagen){
		$("#VerForm").show();
		$("#btnNuevo").hide();
		$("#VerListado").hide();
	    ...
	    $("#txtNombre").val(nombre);
			$("#txtcodigo3").val(codigo_interno);
			$("#minima").val(minima);

	    $("#txtDescripcion").val(descripcion);
			 $("#instruccion").val(instruccion);
		 $("#vrestringida").val(vrestringida);
		  $("#numero").val(numero);
