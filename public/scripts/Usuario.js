...
function init(){
	...
	function Limpiar(){
	   ...
	   // $("#chkMnuAlmacen").attr('checked', false);
	    ...
	    //$("#chkMnuCaja").attr('checked', false);
			//$("#chkMnuSeguridad").attr('checked', false);
			//$("#chkMnuProductos").attr('checked', false);
...
function cargarDataUsuario(idUsuario, idSucursal, idempleado, empleado, tipo_usuario, mnu_almacen, mnu_compras, mnu_ventas,
	 mnu_mantenimiento, mnu_caja, mnu_consulta_compras, mnu_consulta_ventas, mnu_admin, mnu_productos){
		ListadoUsuarios();
		$("#VerForm").show();
		$("#btnNuevo").hide();
		$("#VerListado").hide();
	    ...
	    if (mnu_productos == 1) {
	    	$("#chkMnuProductos").attr('checked', true);
	    } else {
	    	$("#chkMnuProductos").attr('checked', false);
	    }
}
