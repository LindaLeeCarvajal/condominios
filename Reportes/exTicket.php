...
<table border="0" align="center" width="300px">
    ...
    <tr>
        <td align="center"><?php date_default_timezone_set('America/La_Paz'); echo "Fecha/Hora: ".date("Y-m-d  g:i a"); ?></td>
    </tr>
...
<table border="0" align="center" width="300px">
    ...
    <td align="right"><b><?php echo $descuento;  ?><?php echo "%"?></b></td>
    </tr>
     <tr>
    <td>&nbsp;</td>
    <td align="right"><b>TOTAL FINAL:</b></td>
    <td align="right"><b><?php echo "Bs."?><?php echo ($total-(($descuento*$total)/100));  ?></b></td>
    </tr>
    <tr>
