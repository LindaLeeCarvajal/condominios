<?php
	...
	switch ($_GET["op"]) {
		...
		case 'SaveOrUpdate':
			...
			if(isset($_POST["chkMnuProductos"])){
				$prod = true;
			} else {
				$prod = 0;
			}
	    ...
	    case "IngresarSistema":
			...
			if(isset($fetch)){
				...
				$_SESSION["mnu_caja"] = $fetch->mnu_caja;
				$_SESSION["mnu_productos"] = $fetch->mnu_productos;
		...
		case "IngresarPanel" :
				...
				$_SESSION["mnu_caja"] = $_POST["mnu_caja"];
				$_SESSION["mnu_productos"] = $_POST["mnu_productos"];
